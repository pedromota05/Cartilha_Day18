            ...
            <div className="container-wrapper">
                <nav id="sidebarMenu" className="collapse d-lg-block sidebar bg-white">
                    <div className="position-sticky">
                        <div id="summary" className="list-group list-group-flush mt-4 py-2">
                            <Image className="img-sidebar-top mx-3" src={LogoIFEmbrapa} alt="" width="45%" height={50} priority/>
                    ...
                    <div id='main-navbar-options-menu' style={{marginTop: 32}}>
                        <Image className="img-sidebar-top mx-3" src={LogoIFEmbrapa} alt="" width="45%" height={50} priority/>
                        <hr className="featurette-divider line-menu"></hr>
                        <ul className="navbar-nav ms-auto d-flex flex-row itens-menu-cap">
                ...
                <nav id="main-navbar" className="navbar navbar-expand-lg navbar-light bg-white fixed-top">
                    <div className="container-fluid">
                        ...
                        <a className="navbar-brand" href="/">
                            <Image src={Logo} width="100%" height={26} alt="logo Embrapa com letras em azul com um simbolo verde, sendo que as letras em cima do simbolo são brancas" priority/>
                        </a>
                        ...
                        <ul className="navbar-nav ms-auto d-flex flex-row">
                            ...
                            <li className="nav-item">
                                <Image src={LogoIF} className='logotipo me-3 img' width="100%" height={32} alt="logo Embrapa com letras em azul com um simbolo verde, sendo que as letras em cima do simbolo são brancas" priority/>
                            </li>
                            <li className="nav-item me-3 me-lg-0">
                                <Image src={LogoEmbrapa} className='logotipo img' width="100%" height={48} alt="logo Embrapa com letras em azul com um simbolo verde, sendo que as letras em cima do simbolo são brancas" priority/>
                            </li>
